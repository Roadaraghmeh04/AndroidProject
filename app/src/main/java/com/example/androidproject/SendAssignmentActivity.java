...
public class SendAssignmentActivity extends AppCompatActivity {
    ...
    String selectedDate = "";
    int teacherId = -1;  // ← استقبال المعرف
    ...
    private void submitAssignment() {
        ...
        String url = "http://10.0.2.2/school_api/add_assignment.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("uploaded_by", String.valueOf(teacherId));  // استخدام المعرف المستلم
                return params;
            }
        };
